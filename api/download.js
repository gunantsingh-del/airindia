...
<style>
  ...
  .btn-ghost { color: #FFE9A8; border: 1px solid rgba(255,225,89,.3); }
...
<div class="wrap">
  ...
  <p>
    ...
    typically takes about three minutes. The page will refresh
    automatically.
  </p>
  <div class="spinner" aria-hidden="true"></div>
  <div class="actions">
    <a class="btn btn-primary" href="/api/download?refresh=1&amp;file=${assetName}">Check now</a>
